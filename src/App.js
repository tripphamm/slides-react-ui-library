    ...
    return (
      <div className="reveal">
        <div className="slides">
          ...
          <Slide>
            <h3><Emoji unicodeOrShortName=":man_raising_hand:" /></h3>
            <p className="fragment fade-in">EJ Hammond</p>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <p className="fragment fade-in" style={{ marginRight: 20 }}>Edward James</p>
              <span><Emoji className="fragment fade-in" unicodeOrShortName=":three:" /></span>
            </div>
            <div className="fragment fade-in" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <img className="plain" style={{ height: 60 }} src={twitterLogo} alt="twitter" />
              <img className="plain" style={{ height: 60 }} src={gitHubLogo} alt="twitter" />
              <p>@tripphamm</p>
          ...
          <Slide>
            <h3><Emoji unicodeOrShortName=":hockey:" /><Emoji unicodeOrShortName=":goal:" /> Goals</h3>
            <p className="fragment fade-in">Make it insanely easy for devs to do the right thing</p>
            <ListWithEmojis
              animated
              items={[
                {
          ...
          <Slide>
            <h3><Emoji unicodeOrShortName=":rocket:" /> Version 1.0</h3>
            <p className="fragment fade-in" style={{ opacity: 0.6 }}>(v1.2.2)</p>
            <ListWithEmojis
              animated
              items={[
                {
